...
public class WebUtil {
    ...
    private static final String CONTENT_TYPE_TEXT_HTML = "html/text";
    ...
    public static boolean isContentTypeText(SavedRequest request) {
        return request.getHeaderValues(CONTENT_TYPE).contains(CONTENT_TYPE_TEXT_HTML);
    }
}
