...
@StepScope
@Component(value="picollectionDataProcessor")
public class PICollectionDataProcessor<R, W extends DataItemWrite> implements ItemProcessor<R, DataItemWrite> {
	...
	public DataItemWrite process(R item) throws Exception {
		...
		return PIDataProcessorFactory.getPIDataProcessor(platform,"coolection").process(item);
	}
}
