...
@StepScope
@Component(value="platformDataProcessor")
public class PlatformDataProcessor<R, W extends DataItemWrite> implements ItemProcessor<R, DataItemWrite> {
	...
	public DataItemWrite process(R item) throws Exception {
		...
		return PIDataProcessorFactory.getPIDataProcessor(platform).process(item);
	}
}
